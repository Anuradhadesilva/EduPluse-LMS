...
export const GET_SUBMISSIONS_BY_PROGRAM_REQUEST = "GET_SUBMISSIONS_BY_PROGRAM_REQUEST";
export const GET_SUBMISSIONS_BY_PROGRAM_SUCCESS = "GET_SUBMISSIONS_BY_PROGRAM_SUCCESS";
export const GET_SUBMISSIONS_BY_PROGRAM_FAILURE = "GET_SUBMISSIONS_BY_PROGRAM_FAILURE";

export const GET_SUBMISSIONS_DETAILS_BY_PROGRAM_REQUEST = "GET_SUBMISSIONS_DETAILS_BY_PROGRAM_REQUEST";
export const GET_SUBMISSIONS_DETAILS_BY_PROGRAM_SUCCESS = "GET_SUBMISSIONS_DETAILS_BY_PROGRAM_SUCCESS";
export const GET_SUBMISSIONS_DETAILS_BY_PROGRAM_FAILURE = "GET_SUBMISSIONS_DETAILS_BY_PROGRAM_FAILURE";