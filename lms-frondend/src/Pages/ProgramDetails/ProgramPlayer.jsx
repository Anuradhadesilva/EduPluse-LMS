            ...
            case 'VIDEO':
                ...
                return (
                    <div
                        ...
                        <div
                            className="aspect-w-16 aspect-h-9 bg-black rounded-lg overflow-hidden shadow-2xl flex-grow">
                            <iframe src={embedUrl}
            ...
            case 'DOCUMENT':
                return (
                    <div
                        ...
                        <Typography
                            variant="h5"
                            className="font-bold mb-2">{title}
                        </Typography>
                        <Button
                            variant="contained"
                            href={document.link}
                            target="_blank"
                            rel="noopener noreferrer">Download Document
                        </Button>
                    </div>
                );
            case 'QUIZ':
